    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.optionsContainer}>
                ...
                >
                    <Text style={[styles.optionTitle, pref === "safari" && styles.optionTextActive]}>Safari (Default)</Text>
                    <Text style={styles.optionSub}>Uses native Linking.openURL to break completely out of this app into Safari.</Text>
                </TouchableOpacity>
                ...
                >
                    <Text style={[styles.optionTitle, pref === "chrome" && styles.optionTextActive]}>Google Chrome</Text>
                    <Text style={styles.optionSub}>Uses the googlechromes:// scheme to jump into Chrome automatically.</Text>
                </TouchableOpacity>
            </View>
